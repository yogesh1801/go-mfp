	...
	tests := []testData{
		{
			hdr: Header{
				...
				To: optional.New(
					AnyURI("urn:uuid:b8310cdf-157f-4e5b-a042-4588f7149ec0")),
			},
...

		{
			hdr: Header{
				...
				RelatesTo: optional.New(
					AnyURI("urn:uuid:9a6942f8-f5dd-47fc-a4c4-9af559a2bc1a")),
				AppSequence: &AppSequence{
					InstanceID:    123456789,
					MessageNumber: 12345,
					SequenceID: optional.New(
						AnyURI("urn:uuid:b8f0cf58-d83d-4d78-944f-de3e648aaaf0")),
				},
			},
			xml: xmldoc.WithChildren(NsSOAP+":Header",
				xmldoc.WithText(NsAddressing+":Action", ActHello.Encode()),
